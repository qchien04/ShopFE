...
import { useBrandFilter } from "../../../../hooks/Brand/useBrand";
import { FilterOutlined, SortAscendingOutlined, TagsOutlined } from "@ant-design/icons";
...
const BrandSidebar = ({ brandId, onFilterChange }: Props) => {
  const { data, isLoading } = useBrandFilter(brandId);
  ...
  }, [sort, selectedCategories, priceRange]);

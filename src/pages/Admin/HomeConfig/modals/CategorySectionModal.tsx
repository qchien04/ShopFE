...
interface Props {
  open: boolean;
  section: CategoryConfig | null;
  onCancel: () => void;
  onSave: (section: CategoryConfig) => void;
}

const CategorySectionModal = ({ open, section, onCancel, onSave }: Props) => {
  ...
  return (
    ...
    <Modal
      open={open}
      title="📂 Cấu hình Section Danh mục"
      onCancel={onCancel}
      onOk={handleSave}
      width={800}
      okText="Lưu lại"
...
export default CategorySectionModal;
